...
effort_hours: 12
risk_if_skipped: "The Pro tier is a scaffold collecting waitlist emails with no way to charge. There is no revenue path. The waitlist exists precisely so this FR can convert it; leaving it stubbed means the audience built in P1 cannot be monetized."
---
...
against the stored subscription state and gates Pro cosmetics and modes (FR-DD-MON-002).
