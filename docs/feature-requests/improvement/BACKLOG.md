...
| DD-C09 | P2 | 20 | mixed | MoR account (Paddle/LS) + VN eligibility confirmed | A06 | C4, M1 | Billing provider abstraction lib/billing.ts + first MoR adapter + webhook-only grant; rewrite FR-DD-MON-001 | OPEN |
...
| ID | Pri | h | Owner | Gate | Depends | Source | Title | Status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DD-D01 | P2 | 16 | agent | two organic seasons run first | C12 | M4 | Season pass: free + paid cosmetic track on the seasons system (FR-DD-OPS-001 first) | OPEN |
