...
owner: Stephen Cheng
created: 2026-06-24
related_frs: [TASK-DD-SOC-002, TASK-DD-COMM-001]
depends_on: [NFR-DOM-001]   # the target score must be trustworthy
blocks: [TASK-DD-SOC-003]
...
one. Pairs with TASK-DD-SOC-002 (per-run OG images) so the link unfurls with an image in chats
