...
owner: Stephen Cheng
created: 2026-06-24
related_frs: [TASK-DD-SOC-001, TASK-DD-COMM-001]
depends_on: [TASK-DD-SOC-001]
blocks: []
...
effort_hours: 7
risk_if_skipped: "A challenge link (TASK-DD-SOC-001) that unfurls as a bare URL gets ignored in a chat or a tweet; the same link with a score card gets clicked. The image is what makes the social loop actually spread, so it ships in the same slice as the challenge links."
---
...
Depends on TASK-DD-SOC-001 (the challenge links this decorates). This is the highest
...
- Profile OG (app/u/[username]) is listed in this spec but the profile page does not exist yet;
  it lands with TASK-DD-COMM-001 (public profiles), which should reuse buildOgQuery + /api/og.
