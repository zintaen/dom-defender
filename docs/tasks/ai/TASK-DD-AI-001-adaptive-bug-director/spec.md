...
owner: Stephen Cheng
created: 2026-06-24
related_frs: [TASK-DD-AI-002, TASK-DD-OPS-001]
depends_on: []
blocks: [TASK-DD-AI-002]
...
heuristic. The function signature is the AI seam: TASK-DD-AI-002 and a later server model can
...
not touch auth, scoring, or the API. Keep the decision struct stable - TASK-DD-AI-002 (replay
coach) and any future learned director reuse it. This task is the concrete "AI" hook in the
