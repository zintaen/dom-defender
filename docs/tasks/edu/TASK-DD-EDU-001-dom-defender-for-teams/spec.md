...
owner: Stephen Cheng
created: 2026-06-24
related_frs: [TASK-DD-AI-002, TASK-DD-SOC-003, TASK-DD-MON-002]
depends_on: [NFR-DOM-001, TASK-DD-COMM-001]
blocks: []
...
source_decisions:
  ...
  - lib/game/coach.ts (TASK-DD-AI-002 output becomes the after-action teaching summary)
...
(TASK-DD-AI-002), and each bug type is annotated with a one-line real-web-concept explainer (drift
...
path that points to CyberSkill, and leave room for a Pro/B2B gate later (TASK-DD-MON-002) without
...
Depends on NFR-DOM-001 (a team event needs a trustworthy board) and TASK-DD-COMM-001 (identity).
...
CyberSkill outreach. A Vietnamese room (TASK-DD-REACH-002) is a strong local-market wedge.
