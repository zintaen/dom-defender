...
owner: Stephen Cheng
created: 2026-06-24
related_frs: [TASK-DD-COMM-001, TASK-DD-COMM-002]
depends_on: [TASK-DD-COMM-001, NFR-DOM-007]
blocks: []
...
Depends on TASK-DD-COMM-001 (identity) and NFR-DOM-007 (moderation). Reuse the rate-limit
