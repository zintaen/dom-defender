...
owner: Stephen Cheng
created: 2026-06-24
related_frs: [TASK-DD-COMM-002, TASK-DD-COMM-004, TASK-DD-SOC-004]
depends_on: []
blocks: [TASK-DD-COMM-002, TASK-DD-COMM-003]
...
No hard dependency, but it is the prerequisite for TASK-DD-COMM-002 (friends), -003 (guilds),
-004 (replay reactions), and TASK-DD-SOC-004 (referrals). Build it early in P1. Reuses the
...
- app/u/[username]/page.tsx: read-only profile (stats, best runs, achievement count, recent
  ...
  og:image - this also closes the TASK-DD-SOC-002 profile-OG deferral, reusing buildOgQuery +
  /api/og.
