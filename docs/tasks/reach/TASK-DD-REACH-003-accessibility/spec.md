...
Depends on NFR-DOM-008, which defines the measurable a11y gate this task satisfies. Pairs with
TASK-DD-REACH-001: large, clearly-focused touch targets serve both touch and keyboard users.
